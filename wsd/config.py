...
logger.info("***************************************************************************************************************")
logger.info("*                                                                                                             *")
logger.info("*     __        ______  ____    ____                                    ____                  _               *")
logger.info("*     \ \      / / ___||  _ \  / ___|  ___ __ _ _ __  _ __   ___ _ __  / ___|  ___ _ ____   _(_) ___ ___      *")
logger.info("*      \ \ /\ / /\___ \| | | | \___ \ / __/ _` | '_ \| '_ \ / _ \ '__| \___ \ / _ \ '__\ \ / / |/ __/ _ \     *")
logger.info("*       \ V  V /  ___) | |_| |  ___) | (_| (_| | | | | | | |  __/ |     ___) |  __/ |   \ V /| | (_|  __/     *")
logger.info("*       _\_/\_/  |____/|____/  |____/ \___\__,_|_| |_|_|_|_|\___|_|  _ |____/ \___|_|    \_/ |_|\___\___|     *")
logger.info("*      / _| ___  _ __  | | | | ___  _ __ ___   ___     / \   ___ ___(_)___| |_ __ _ _ __ | |_                 *")
logger.info("*     | |_ / _ \| '__| | |_| |/ _ \| '_ ` _ \ / _ \   / _ \ / __/ __| / __| __/ _` | '_ \| __|                *")
logger.info("*     |  _| (_) | |    |  _  | (_) | | | | | |  __/  / ___ \\__ \__ \ \__ \ || (_| | | | | |_                 *")
logger.info("*     |_|  \___/|_|    |_| |_|\___/|_| |_| |_|\___| /_/   \_\___/___/_|___/\__\__,_|_| |_|\__|                *")
logger.info("*                                                                                                             *")
